    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_thousands', models.DecimalField(decimal_places=3, max_digits=12, verbose_name='MILLESIMI COMPLESSIVI')),
                ('benef_of_diss_in_invo', models.CharField(max_length=50, verbose_name='BENEFICIARI DELLO SCONTO IN FATTURA')),
                ('thousands_benef_diss', models.DecimalField(decimal_places=3, max_digits=12, verbose_name='MILLESIMI DI BENEFICIO DELLO SCONTO IN FATTURA SU PARTI COMUNI')),
                ...
                ('amount_advance_deposit_by_customer_common', models.DecimalField(decimal_places=3, max_digits=12, null=True, verbose_name='IMPORTO ACCONTO INTERVENTI COMUNI - CASSA PREVIDENZA INCLUSA E IVA INCLUSA')),
                ...
                ('total_adv_deposit_customer', models.DecimalField(blank=True, decimal_places=2, max_digits=12, null=True, verbose_name='IMPORTO COMPLESSIVO ACCONTO - CASSA PREVIDENZA INCLUSA E IVA INCLUSA')),
                ('amount_discount_common', models.DecimalField(decimal_places=3, max_digits=12, null=True, verbose_name='IMPORTO SCONTO IN FATTURA INTERVENTI COMUNI - CASSA PREVIDENZA INCLUSA E IVA INCLUSA')),
                ('amount_discount_subjective', models.DecimalField(decimal_places=3, max_digits=12, null=True, verbose_name='IMPORTO SCONTO IN FATTURA INTERVENTI SOGGETTIVI - CASSA PREVIDENZA INCLUSA E IVA INCLUSA')),
                ('total_discount', models.DecimalField(blank=True, decimal_places=3, max_digits=12, null=True, verbose_name='IMPORTO COMPLESSIVO SCONTO IN FATTURA - CASSA PREVIDENZA INCLUSA E IVA INCLUSA')),
