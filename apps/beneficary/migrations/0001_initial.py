# Generated by Django 3.2.6 on 2021-11-05 08:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('street', models.CharField(max_length=150, verbose_name="VIA E NUMERO IN CUI SI TROVA L'IMMOBILE")),
                ('total_thousands', models.DecimalField(decimal_places=2, max_digits=12, verbose_name='MILLESIMI COMPLESSIVI')),
                ('benef_of_diss_in_invo', models.CharField(max_length=50, verbose_name='BENEFICIARI DELLO SCONTO IN FATTURA')),
                ('thousands_benef_diss', models.DecimalField(decimal_places=2, max_digits=12, verbose_name='MILLESIMI DI BENEFICIO DELLO SCONTO IN FATTURA SU PARTI COMUNI')),
                ...
                ('province_reg_office', models.CharField(blank=True, max_length=20, verbose_name="PROVINCIA ISCRIZIONE REGISTRO IMPRESE SOCIETA' BENEFICIARIA")),
                ('vat_number_company', internationalflavor.vat_number.models.VATNumberField(blank=True, countries=['IT'])),
                ...
                ('cap_of_residance_rep', models.CharField(blank=True, max_length=50, verbose_name="PROVINCIA RESIDENZA LEGALE RAPPRESENTATE SOCIETA' BENEFICIARIA o del BENEFICIARIO PERSONA FISICA")),
                ...
                ('amount_advance_deposit_by_customer_common', models.DecimalField(decimal_places=2, max_digits=12, null=True, verbose_name='IMPORTO ACCONTO INTERVENTI COMUNI - CASSA PREVIDENZA INCLUSA E IVA INCLUSA')),
                ('amount_advance_deposit_by_customer_subjective', models.DecimalField(decimal_places=2, max_digits=12, null=True, verbose_name='IMPORTO ACCONTO INTERVENTI SOGGETTIVI - CASSA PREVIDENZA INCLUSA E IVA INCLUSA')),
                ('total_adv_deposit_customer', models.DecimalField(decimal_places=2, max_digits=12, null=True, verbose_name='IMPORTO COMPLESSIVO ACCONTO - CASSA PREVIDENZA INCLUSA E IVA INCLUSA')),
                ('amount_discount_common', models.DecimalField(decimal_places=2, max_digits=12, null=True, verbose_name='IMPORTO SCONTO IN FATTURA INTERVENTI COMUNI - CASSA PREVIDENZA INCLUSA E IVA INCLUSA')),
                ('amount_discount_subjective', models.DecimalField(decimal_places=2, max_digits=12, null=True, verbose_name='IMPORTO SCONTO IN FATTURA INTERVENTI SOGGETTIVI - CASSA PREVIDENZA INCLUSA E IVA INCLUSA')),
                ('total_discount', models.DecimalField(decimal_places=2, max_digits=12, null=True, verbose_name='IMPORTO COMPLESSIVO SCONTO IN FATTURA - CASSA PREVIDENZA INCLUSA E IVA INCLUSA')),
            ],
        ),
    ]
